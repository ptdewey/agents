...
_Source: Spinellis, "Code Reading: The Open Source Perspective" (2003) — start with the build system and README before reading any application code._
...
_Source: Spinellis (2003) — "directory tree as table of contents."_
...
_Source: Hermans, "The Programmer's Brain" (2021, Manning) — follow the entry point and call graph one level at a time._
...
_Source: Storey et al., "How Software Developers Use Tools, Cognitive Strategies, and Representations to Navigate Code" (IEEE TSE, 2006) — use the test suite as a specification._
...
_Source: Spolsky practitioner writing — "find the biggest, most-edited file; read git history to understand why code is the way it is."_
...
- Write narratively — explain _why_ the code is structured this way, not just _what_ it does
